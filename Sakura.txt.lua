...
function CheckQuest()
	...
	elseif World3 then
		...
		elseif ((MyLevel == 1700) or (MyLevel <= 1725)) then
		...
		elseif ((MyLevel == 1725) or (MyLevel <= 1775)) then
...
-- 🌾 Thêm chức năng Farm Level vào danh mục Farm
Tabs.Farm:AddToggle({
    ...
    Callback = function(Value)
        ...
        task.spawn(function()
            while _G.AutoFarmLevel do
                ...
                -- Gọi hàm kiểm tra nhiệm vụ
                CheckQuest()

                -- Nếu có nhiệm vụ thì nhận và farm
                local Player = game.Players.LocalPlayer
                local QuestTitle = Player.PlayerGui.Main.Quest.Container.QuestTitle
